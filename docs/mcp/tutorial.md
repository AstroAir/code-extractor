...
For detailed information about each tool, refer to the [MCP API Reference](api.md).

## Next Steps

- Explore the [Advanced Features](advanced.md) documentation
- Learn about [Customizing Search Behavior](../guide/configuration.md)
- Check out [Real-world Examples](https://github.com/AstroAir/pysearch/blob/main/examples/mcp_server_example.py)