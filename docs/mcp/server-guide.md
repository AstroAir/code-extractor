...
metrics = await get_resource("https://github.com/AstroAir/pysearch/blob/main/pysearch://performance/metrics")

# Monitor cache performance
cache_analytics = await get_resource("https://github.com/AstroAir/pysearch/blob/main/pysearch://cache/analytics")

# Check health status
health = await get_resource("https://github.com/AstroAir/pysearch/blob/main/pysearch://health/status")
```
...
```bash
# Check server health
curl "https://github.com/AstroAir/pysearch/blob/main/pysearch://health/status"
```
...
```bash
# Get usage analytics
curl "https://github.com/AstroAir/pysearch/blob/main/pysearch://analytics/usage"
```
...
curl "https://github.com/AstroAir/pysearch/blob/main/pysearch://performance/metrics"
```
