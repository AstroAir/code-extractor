...
from pysearch import PySearch, SearchConfig, Query, ASTFilters, MetadataFilters, OutputFormat
...
class TestDataHelper:
    ...
    def assert_search_results(results, expected_count: int = None, contains_text: str = None):
        ...
        if expected_count is not None:
            assert len(results.items) >= expected_count, f"Expected at least {expected_count} results"
