...
class TestVectorSearchResult:
    ...
    def test_init_without_vector(self):
        ...
        result = VectorSearchResult(id="test_id", score=0.85, payload={"entity_type": "class"})
...
class TestQdrantVectorStore:
    ...
    def test_init_without_qdrant(self):
        ...
        with patch("pysearch.storage.qdrant_client.QDRANT_AVAILABLE", False):
    ...
    @patch("pysearch.storage.qdrant_client.QDRANT_AVAILABLE", True)
    @patch("pysearch.storage.qdrant_client.QdrantClient")
    @patch("pysearch.storage.qdrant_client.models")
    @pytest.mark.asyncio
...
class TestVectorUtilities:
    ...
    @patch("pysearch.storage.qdrant_client.QDRANT_AVAILABLE", True)
    @patch("pysearch.storage.qdrant_client.np")
...
class TestQdrantIntegration:
    ...
    async def test_full_workflow(self):
        ...
        config = QdrantConfig(host="localhost", port=6333, collection_name="test_collection")
